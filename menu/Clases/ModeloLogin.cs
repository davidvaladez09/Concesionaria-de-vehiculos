...
namespace menu.Clases
{
    class ModeloLogin
    {
        ...
        public empleado_vendedor_usuario porUsuario(string usuario)
        {
            ...
            string sql = "SELECT idEmpleado_Vendedor_Usuario, Nombre, Password, Tipo_Usuario FROM empleado_vendedor_usuario WHERE Usuario='david_valadez' AND Tipo_Usuario='1'";
            MySqlCommand comando = new MySqlCommand(sql, conexion);
            comando.Parameters.AddWithValue("@usuario", usuario);
